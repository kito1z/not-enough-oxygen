...
public class LargeTankModel<T extends LivingEntity> extends EntityModel<T> {
    // Register this in your renderer context
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation("not_enough_oxygen", "large_tank"), "main");

    private final ModelPart tank_medium;
    private final ModelPart tank_medium2;

    public LargeTankModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // Second tank part, child of first
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount,
        ...
        // No animation needed for static wearable
    }
