...
public class MediumTankCurioRenderer implements ICurioRenderer {

    private static final ResourceLocation TEXTURE = new ResourceLocation(NotEnoughOxygen.MODID, "textures/item/medium_tank.png");

    private final MediumTankModel<LivingEntity> model;

    public MediumTankCurioRenderer(EntityModelSet modelSet) {
        this.model = new MediumTankModel<>(modelSet.bakeLayer(MediumTankModel.LAYER_LOCATION));
    }
