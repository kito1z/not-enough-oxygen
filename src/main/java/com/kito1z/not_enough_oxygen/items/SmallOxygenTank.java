...
import com.kito1z.not_enough_oxygen.utils.OxygenHelper;
...
public class SmallOxygenTank extends Item implements ICurioItem {
    ...
    public void curioTick(SlotContext slotContext, ItemStack stack) {
        ...
        if (player.getEffect(NEOEffects.OXYGEN_SATURATION.get()) != null &&
                player.getEffect(NEOEffects.OXYGEN_SATURATION.get()).getDuration() >= 2) {
            return;
        }
